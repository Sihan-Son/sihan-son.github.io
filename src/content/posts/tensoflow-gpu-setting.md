...
date: 2019-07-04
section: setting
slug: tensoflow-gpu-setting
thumbnail: /images/thumbnails/tensoflow-gpu-setting.svg
categories:
  - Setting
tags:
  - Setting
...
먼저 `anaconda`가 필요하다. `anaconda`는 과학용 파이썬 패키지를 묶어서 배포하는 배포판 인데 이 내용은 다음에 알아보도록 하고, `anaconda`가 설치 되어 있다는 사람들을 대상으로 글을 쓴다. 혹시 `anaconda` 설치가 필요하다면 [이 글](https://dev-hani.tistory.com/10)을 참조해서 설치하길 바란다.
